 ...
 * Created by .
 */
@WebServlet(name = "students",value = "/studentsEnglish")
public class StudentsEnglishServlet extends HttpServlet {
    private String message;
    private List<Student> students = new ArrayList<>();

    public void init() {
        message = "Students english";
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Student> students = entityManager.createNativeQuery("select *\n" +
                ...
                "where C_ID = 2",Student.class).getResultList();
